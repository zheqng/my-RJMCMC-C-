...
datha<- read.table("data.sts",fill=TRUE,col.names = c("iter number","K","log lik","split/merge","acc/reject","prob","simu_acc/simu_rej","prob","death or reserve"))
...
traindata$temp =read.table("data.dat")
