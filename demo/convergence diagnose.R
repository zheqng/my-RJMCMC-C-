...
pi.mean = apply(PI[1:1159,],2,mean)
w.mean=apply(w[1:1159,],2,mean)
v.mean=apply(v[1:1159,],2,mean)
sigma2.mean = apply(sigma2[1:1159,],2,mean)
...
calc.rhat(PI[1:1000,],w[1:1000,],v[1:1000,],sigma2[1:1000,])
